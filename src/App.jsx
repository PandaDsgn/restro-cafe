  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        <Link
          to="/"
          className="text-2xl md:text-3xl font-serif tracking-[0.2em] text-stone-900 uppercase flex items-center gap-3"
        >
          The Restro-Cafe
        </Link>
  ...
  const handleReservation = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.error("Email failed to send:", emailError?.status, emailError?.text);
      }
